    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistHasGenre", x => new { x.GenreId, x.ArtistId });
                    table.ForeignKey(
                        name: "FK_ArtistHasGenre_Artirts_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artirts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistHasGenre_Genres_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonInfo_Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PersonInfo_Surname = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PersonInfo_Birthday = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PersonInfo_CPF = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistHasEvent", x => new { x.EventId, x.ArtistId });
                    table.ForeignKey(
                        name: "FK_ArtistHasEvent_Artirts_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artirts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistHasEvent_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreHasEvent", x => new { x.EventId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_GenreHasEvent_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreHasEvent_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistHasEvent_ArtistId",
                table: "ArtistHasEvent",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistHasGenre_ArtistId",
                table: "ArtistHasGenre",
                column: "ArtistId");
